...
@given(integers(), integers(min_value=0, max_value=10000), booleans())
...
@example(42, 3, False)
@example(42, 3, False)
@example(1000, 2, False)
@example(1000, 4, False)
@example(-2049, 1, True)
@example(-65281, 3, True)
@example(-65281, 3, True)
def test_to_bytes(byteorder, x, length, signed):
    try:
...
@example(-2, 3, True)
@example(-2, 5, True)
def test_from_bytes(byteorder, x, length, signed):
    try:
